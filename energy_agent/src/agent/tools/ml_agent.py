...
def ml_agent(task: str, state: Annotated[AgentState, InjectedToolArg]):
    ...
    When providing points or coordinates, it is **mandatory** that they are given in **text form** (e.g., as plain numbers separated by commas or spaces) and **not** in any structured format like JSON, CSV files, or tables.
