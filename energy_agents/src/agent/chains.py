"""
Agent system prompt and chain setup.

Defines:
- The system prompt for the AI agent with instructions for handling structured/unstructured data.
- The ChatPromptTemplate for LangChain with system + user messages.
- The agent_chain that connects the prompt template to the AI model with tools.
"""
...
agent_chain = agent_prompt_template | model_with_tools
