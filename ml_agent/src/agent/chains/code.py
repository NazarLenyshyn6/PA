...
- **All map-based visualizations must have a proper 2D map background** with visible cities, roads, and terrain.  
- **Never use blank canvas or globe-style 3D projections.**
...
{data_summaries}
    ...
    **NEW INSTRUCTION:**  
    ...
    IMPORTANT EXECUTION RULES
        ...
        - Never plot on a blank canvas or use globe-style visualizations.
    """
        ),
    ]
)
